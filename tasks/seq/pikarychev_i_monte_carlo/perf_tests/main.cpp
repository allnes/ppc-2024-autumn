...
TEST(pikarychev_i_monte_carlo_seq, TestPipelineRun) {
  double a = 0.0;
  double b = 2.0;
  ...
  auto testTaskSequential = std::make_shared<pikarychev_i_monte_carlo_seq::TestTaskSequential>(taskData);
...
TEST(pikarychev_i_monte_carlo_seq, TestTaskRun) {
  double a = 0.0;
  double b = 2.0;
  int num_points = 10000000;
  auto taskData = std::make_shared<ppc::core::TaskData>();
